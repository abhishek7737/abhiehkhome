    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active home">
                        <a class="nav-link" style="display: inline;" href="Dashboard.php" title="home"><i class="fa fa-home" style="font-size: 19px;" aria-hidden="true"></i><span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item home">
                        <a class="nav-link" style="display: inline;" href="login.php" title="login"><i class="fas fa-sign-in-alt" style="font-size: 19px;" aria-hidden="true"></i><span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav><!-- NavBar END   -->                      
        ...
        <div class="row" id="body-row">
            ...
            <div class="col p-4 d-none d-sm-block">
                    <div id="carouselExampleFade" class="container carousel slide carousel-fade " data-ride="carousel" style=" width: 58%;   margin: 0 auto;">
