...
if(isset($_REQUEST['submit'])){
   ...
   // die;
    $sql=" SELECT * FROM volunteers_list WHERE NAME like '%".$search."%' OR Gender like '%".$search."%' OR Address like '%".$search."%' OR Sub_Center like '%".$search."%' OR RANKS like '%".$search."%' OR Mobile_No like '%".$search."%' OR Training_Demo like '%".$search."%'";
	...
	if($result = mysqli_query($link, $sql)){
		if(mysqli_num_rows($result) > 0){
			while($row = mysqli_fetch_array($result)){
                ...
                echo "<td class='hinditext'>" . $row['Name'] . "</td>";
                echo "<td>" . $row['Gender'] . "</td>";
                echo "<td class='hinditext'>" . $row['Address'] . "</td>";
				 echo "<td>" . $row['Sub_Center'] . "</td>";
                echo "<td>" . $row['RANKS'] . "</td>";
				echo "<td>" . $row['Mobile_No'] . "</td>";
                echo "<td>" . $row['Training_Demo'] . "</td>";
